import Componentbypass from "../components/bypass.svelte";
import {mount_component,transition_in,children,flush} from "svelte/internal";

export class border extends Componentbypass{
...
export const bypass = (component,props,slots)=>new border({props:{component,slots,...props}});

export const Render = (component,props,slots)=>bypass(component,props,slots);